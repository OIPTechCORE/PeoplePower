...
async function main() {
  console.log("🚀 Deploying Infinity Payment Processor...");
  ...
  const TON_TOKEN_ADDRESS = "0x1234567890123456789012345678901234567890"; // Placeholder
  const SUPER_ADMIN_ADDRESS = deployer.address; // Initially set to deployer
