...
export declare enum TransparencyLevel {
    FULL = "full",
    HIGH = "high",
    MEDIUM = "medium",
    LOW = "low",
...
export declare enum PublicAccess {
    PROPOSALS = "proposals",
...
export declare enum JusticeType {
    CIVIL = "civil",
    CRIMINAL = "criminal",
    ADMINISTRATIVE = "administrative",
...
export declare enum EvolutionPhase {
...
//# sourceMappingURL=civilization-advanced.d.ts.map