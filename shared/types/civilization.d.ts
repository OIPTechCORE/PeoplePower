...
export declare enum FacultyType {
...
export declare enum PrestigeLevel {
...
export declare enum PowerPillarType {
    CITIZENS = "citizens",
...
export declare enum SafetyStructureType {
...
export declare enum GovernanceLayerType {
    CITIZENS = "citizens",
    COMMUNITIES = "communities",
    INSTITUTIONS = "institutions",
    COUNCILS = "councils",
...
export declare enum VoteWeighting {
    EQUAL = "equal",
...
export declare enum QuorumRequirement {
    FIXED_NUMBER = "fixed_number",
    PERCENTAGE = "percentage",
    ADAPTIVE = "adaptive"
}
export declare enum IncomeSourceType {
...
export declare enum TreasuryType {
...
//# sourceMappingURL=civilization.d.ts.map