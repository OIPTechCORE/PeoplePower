...
export declare enum LeaderboardTier {
    BRONZE = "bronze",
    SILVER = "silver",
    GOLD = "gold",
    PLATINUM = "platinum",
...
export declare enum TitleRarity {
    COMMON = "common",
    UNCOMMON = "uncommon",
    RARE = "rare",
    EPIC = "epic",
...
export declare enum StreakType {
    DAILY = "daily",
    WEEKLY = "weekly",
    MONTHLY = "monthly"
}
...
export declare enum AdminAccessLevel {
    READ_ONLY = "read_only",
    MODERATOR = "moderator",
...
export declare enum AdminModule {
    USERS = "users",
    CONTENT = "content",
    ECONOMY = "economy",
    SYSTEM = "system",
...
export declare enum ContentFlagType {
...
export declare enum ModeratorRole {
    TRAINEE = "trainee",
    MODERATOR = "moderator",
...
//# sourceMappingURL=ecosystems-final.d.ts.map